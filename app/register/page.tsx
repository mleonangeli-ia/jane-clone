...
export default function RegisterPage() {
  ...
  return (
    <div className="flex min-h-screen">
      {/* Left */}
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between bg-gradient-to-br from-[#0a1e3d] via-[#0c2d4e] to-[#071528] p-12 text-white">
          ...
          <ul className="space-y-3">
            {perks.map((p) => (
              <li key={p} className="flex items-center gap-3 text-gray-300">
                <CheckCircle className="h-5 w-5 shrink-0 text-sky-400" />
                <span>{p}</span>
              </li>
            ))}
          </ul>
