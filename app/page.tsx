          ...
          <div className="relative mx-auto max-w-6xl w-full px-6 py-32">
            <div className="max-w-2xl">
              ...
              <div className="mt-10 flex flex-col gap-3 sm:flex-row">
                <Link href="/register">
                  <button className="flex h-13 items-center gap-2 rounded-xl bg-sky-500 px-8 py-3.5 text-base font-bold text-white shadow-xl shadow-sky-900/40 transition-all hover:-translate-y-0.5 hover:bg-sky-400 hover:shadow-2xl">
                    Crear cuenta gratis
          ...
          <div className="mx-auto max-w-6xl px-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {features.map(({ icon: Icon, title, desc }, i) => (
                <div
                  key={title}
                  className="group relative overflow-hidden rounded-2xl border border-white/5 bg-white/5 p-6 transition-all duration-300 hover:border-sky-500/30 hover:bg-white/8 hover:-translate-y-1"
                  style={{ animationDelay: `${i * 60}ms` }}
                >
                  <div className="mb-4 inline-flex h-11 w-11 items-center justify-center rounded-xl bg-sky-500/10">
                    <Icon className="h-5 w-5 text-sky-400" />
                  </div>
                  <h3 className="mb-2 font-bold text-white" style={{ letterSpacing: "-0.02em" }}>{title}</h3>
                  <p className="text-sm leading-relaxed text-gray-400">{desc}</p>
                  <div className="absolute bottom-0 left-0 h-px w-0 bg-sky-500 transition-all duration-500 group-hover:w-full" />
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="testimonials" className="bg-gray-950 pb-28">
          <div className="mx-auto max-w-6xl px-6">
            <div className="mb-12 text-center">
              <p className="mb-3 text-sm font-bold uppercase tracking-widest text-sky-400">Testimonios</p>
              <h2 className="text-3xl font-black tracking-tight text-white sm:text-4xl" style={{ letterSpacing: "-0.03em" }}>
              ...
              {testimonials.map((t) => (
                <div key={t.name} className="rounded-2xl border border-white/5 bg-white/5 p-6">
                  ...
                  <div className="mt-5 flex items-center gap-3">
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-sky-500/20 text-sm font-bold text-sky-400">
                      {t.initials}
                    </div>
                    <div>
